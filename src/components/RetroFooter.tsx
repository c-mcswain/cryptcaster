    ...
    <footer className="mt-auto border-t-4 border-lichen-green bg-crypt-purple py-20 px-8 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-12 relative z-10">
        <div className="text-center md:text-left space-y-4">
          <div className="font-creepy text-5xl text-slime-green/80 mb-4 glow-text tracking-widest">INVITE ME IN</div>
        ...
        <div className="flex flex-wrap justify-center gap-6">
          ...
          <div className="bg-black/40 border border-slime-green/30 px-4 py-2 font-pixel text-xs text-slime-green/50 flex flex-col items-center leading-tight tracking-widest">
            ...
            <span className="text-sm font-bold text-slime-green/80">NETSCAPE</span>
          </div>
          <div className="bg-black/40 border border-phantom-pink/30 px-4 py-2 font-pixel text-xs text-phantom-pink/50 flex flex-col items-center leading-tight tracking-widest">
            <span>MADE WITH</span>
            <span className="text-sm font-bold text-phantom-pink/80">SLIME</span>
          </div>
          <div className="bg-black/40 border border-white/20 px-4 py-2 font-pixel text-xs text-white/30 flex flex-col items-center leading-tight tracking-widest">
            <span>BROADCAST</span>
            <span className="text-sm font-bold text-white/50">100% SPOOKY</span>
          </div>
        </div>
        <div className="flex flex-col items-center md:items-end gap-6">
          ...
          <div className="flex items-center gap-3 font-pixel text-base text-phantom-pink/40 hover:text-phantom-pink hover:underline cursor-pointer group tracking-[0.2em]">
            CHANNEL LINK <ExternalLink className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
          </div>
        </div>
      </div>
      <div className="max-w-7xl mx-auto mt-16 pt-10 border-t border-white/5 text-center font-pixel text-sm text-white/20 leading-relaxed max-w-4xl tracking-widest uppercase opacity-40">
