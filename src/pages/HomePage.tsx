    ...
    <div className="min-h-screen flex flex-col relative bg-black overflow-x-hidden selection:bg-slime-green selection:text-black">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex-1 z-10 w-full">
        <div className="py-6 md:py-8">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-5 mb-9 md:mb-10">
          ...
          {!loading && (
            <section className="space-y-9 md:space-y-10 mb-11 md:mb-12">
              <div className="text-center relative max-w-6xl mx-auto">
                ...
                <p className="font-pixel text-sm md:text-base text-phantom-pink/68 uppercase tracking-[0.28em] md:tracking-[0.4em] mb-4">
                  Current Issue
                </p>

                <h1 className="gothic-header text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl mb-5 tracking-[0.08em] md:tracking-[0.15em] animate-pulse-glow leading-[0.96] break-normal">
                  THE MIDNIGHT ZINE
                </h1>

                <p className="font-pixel text-xl md:text-3xl text-slime-green/82 uppercase tracking-[0.16em] md:tracking-[0.28em] leading-relaxed">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-7 md:gap-9 items-stretch">
                <div className="lg:col-span-4 flex flex-col gap-6">
                  <div className="retro-window border-white/5 flex-1 shadow-2xl">
                    ...
                    <div className="p-6 md:p-7 bg-black/80 font-mono text-base md:text-lg leading-[1.65] text-white/70 italic space-y-5">
                ...
                <div className="lg:col-span-8 h-full">
                  ...
                  >
                    <img
                      ...
                      className="absolute inset-0 w-full h-full object-cover grayscale opacity-14 group-hover:grayscale-0 group-hover:opacity-40 transition-all duration-[2000ms] scale-105 group-hover:scale-100"
                      alt="Zine Cover"
                    />
